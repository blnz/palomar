 ...
 */
public class FXOMBuilderImpl implements SAXTwoOMBuilder 
{
     ...
     */
    public FXOMBuilderImpl()
    {}

    public FXOMBuilderImpl(LoadContext context, 
                        String systemId, 
                        int documentIndex,  
                        ...
                        int index, ContainerNodeImpl parent, Hashtable namespaces) throws XSLException 
        {
            ...
            if (namespaces.size() > 0) {
                ...
                while (keys.hasMoreElements()) {
                    ...
                    //    System.out.println("FXOMBuilder:ElementNodeImpl()  -- binding prefix [" + prefix + "] to [" + ns  + "]");
