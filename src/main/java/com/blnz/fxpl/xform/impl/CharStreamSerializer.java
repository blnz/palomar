// $Id: CharStreamSerializer.java 46 2004-12-11 00:39:16Z blindsey $
 ...
 */
public class CharStreamSerializer extends XMLFilterImpl
{
     ...
     */
    public CharStreamSerializer(Writer os)
    {
        // the actual work of writing chars is done by handler
        _handler = new OutWriterContentHandler(os);
