// $Id: HTMLWriterContentHandler.java 870 2009-10-19 22:26:01Z blindsey $
...
/**
 * A ContentHandler that writes an HTML representation.
 */
public class HTMLWriterContentHandler 
    implements ContentHandler
{
    ...
    public HTMLWriterContentHandler() { }
        ...
        if (inCdata) {
            ...
            for (; len > 0; len--, off++) {
                ...
                case '\n':
                    ...
                    break;
                case '&':
                    if (currentElement.equalsIgnoreCase("script")){
                        write('&');
                    }
                    else {
                        write("&amp;");
        ...
        throws SAXException 
    {
        ...
        if (name == null) {
            throw new SAXException("null Element Name");
        }
