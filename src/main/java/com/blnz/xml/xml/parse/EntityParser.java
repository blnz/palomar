...
import com.blnz.util.Hashtable;

import com.blnz.xml.parse.base.Application;
import com.blnz.xml.tok.*;
...
implements StartElementEvent, EndElementEvent, CharacterDataEvent,
  ...
  private void doFatal(String id, Object[] args) throws NotWellFormedException {
	...
	= ResourceBundle.getBundle("com.blnz.xml.parse.Messages", locale);
